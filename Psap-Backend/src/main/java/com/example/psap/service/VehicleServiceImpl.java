...
public class VehicleServiceImpl implements IVehicleService {
    ...
    public Vehicle addUsersVehicle(Vehicle vehicle) throws DuplicateVehicleException {
        Optional<Vehicle> vehicle2 = vehicleDao.findById(vehicle.getVehicleId());
        if (vehicle2.isPresent()) {
            throw new DuplicateVehicleException("data already existing");
        } else {
...
//        Optional<ParkingSlots> parkingSlots1=parkingSlotsDao.findByVehicleNumberslots(vehicleNumber);
//        Optional<Vehicle> vehicle2 = vehicleDao.findByVehicleNumber(vehicleNumber);
//        if (vehicle2.isPresent()) {
//            ParkingSlotsDao.deleteByVehicleNumber(vehicleNumber);
//        } else {
...
//    @Override
//    public Vehicle removeVehicleByVehicleNumber(String vehicleNumber) {
//        Optional<ParkingSlots> parkingSlots1 = parkingSlotsDao.findByVehicleNumber(vehicleNumber);
//        if (vehicle2.isPresent()) {
