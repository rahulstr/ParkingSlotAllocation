...
public class GlobalValidationHandler extends ResponseEntityExceptionHandler
{
    ...
    public ResponseEntity<String> handleDuplicateUserException(DuplicateUserException exec)
    {

        return new ResponseEntity<String>("We already have a user with same details. Please enter different details..!", HttpStatus.NOT_FOUND);
    }
