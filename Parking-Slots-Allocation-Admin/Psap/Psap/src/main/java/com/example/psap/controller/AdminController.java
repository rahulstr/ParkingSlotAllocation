...
public class AdminController
{
	...
	public ResponseEntity<Optional<ParkingPremise>> getPremise(@PathVariable Integer parkingPremiseId) throws NoSuchParkingPremiseException {
	...
	public ResponseEntity<Optional<ParkingPremise>> getPremiseByName(@PathVariable String parkingPremiseName) throws NoSuchParkingPremiseException {
	...
	public ResponseEntity<ParkingPremise> createParkingPremise(@Valid @RequestBody ParkingPremise premise) throws DuplicateParkingPremiseException {
