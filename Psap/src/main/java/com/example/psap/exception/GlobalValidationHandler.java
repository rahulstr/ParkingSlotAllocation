...
public class GlobalValidationHandler extends ResponseEntityExceptionHandler
{
	...
	public ResponseEntity<String> handleDuplicateUserException(Exception e){
        ...
        responseEntity = new ResponseEntity<>("We this user already, please enter some other details",HttpStatus.NOT_ACCEPTABLE);
	...
	public ResponseEntity<String> handleNotificationException(Exception e){
		ResponseEntity<String> responseEntity;
        responseEntity = new ResponseEntity<>("Notification Exeption please verify the user's email Id",HttpStatus.NOT_ACCEPTABLE);
        return responseEntity;
	}
